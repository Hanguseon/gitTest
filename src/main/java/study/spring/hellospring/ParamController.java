...
/**
 * Spring은 하나의 컨트롤러가 하나 이상의 페이지를 표현할 수 있다. 클래스는 폴더의 개념이 되고, 이 안에서의 메서드들은 페이지의
 * 개념이 된다.
 */
...
public class ParamController {
	...
	/*public String post(Locale locale, Model model, @RequestParam(value = "user_name", defaultValue = "") String name,
